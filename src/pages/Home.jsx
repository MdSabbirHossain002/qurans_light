...
// ✅ Helper 1: HEX থেকে RGB কনভার্টার (নতুন আয়াতের জন্য)
...
// ✅ Helper 2: ছবি থেকে অটোমেটিক কালার এক্সট্রাক্টর (পুরোনো আয়াতের জন্য)
...
export default function Home({ language }) {
  ...
  // ✅ আয়াত চেঞ্জ হলে থিম কালার ম্যাজিক ট্রিগার হবে
  ...
  useEffect(() => {
    ...
    if (currentVerse) {
      ...
      if (currentVerse.theme_color) {
        ...
        setThemeColor(hexToRgb(currentVerse.theme_color)); // নতুন আয়াতের সরাসরি কালার

      } else if (currentVerse.bg_image) {

        extractDominantColor(currentVerse.bg_image, (color) => {

          setThemeColor(color || "16, 185, 129"); // পুরোনো আয়াতের ছবি স্ক্যান
